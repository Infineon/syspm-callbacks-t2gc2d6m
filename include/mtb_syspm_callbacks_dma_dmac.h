/***************************************************************************//**
* \file mtb_syspm_callbacks_dma_dmac.h
*
* Description:
* Provides the implementation for syspm callbacks for the DMAC IP.
*
********************************************************************************
* \copyright
...
__STATIC_INLINE  bool _mtb_syspm_dma_dmac_is_active(const cy_stc_syspm_callback_params_t* params,
                                                    uint32_t channelNum)
{
    return ((Cy_DMAC_GetActiveChannel((params->base)) & (1u << channelNum)) > 0u);
}
